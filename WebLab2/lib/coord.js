...
drawTriangle(originX, originY, originX + 2 * unitSegment, originY, originX, originY - unitSegment);
drawRectangle(originX-2*unitSegment, originY, 2*unitSegment, unitSegment);
drawEllipse(`M ${originX} ${originY+unitSegment} A ${unitSegment} ${unitSegment} 0 0 0 ${originX + unitSegment} ${originY} L ${originX} ${originY} Z`);